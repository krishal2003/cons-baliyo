...
export const PATH_PAGE = {
  ...
  blog: {
    root: '/blog',
    view: (slug: string) => `/blog/post/${slug}`,
  },
  event: {
    root: '/events',
    view: (slug: string) => `/events/${slug}`,
  },
...
export const PATH_DASHBOARD = {
  ...
  quote: path(ROOTS_DASHBOARD, '/quote'),
  provider: path(ROOTS_DASHBOARD, '/provider'),
  ...
  player: {
    freeOrganization: {
      list: path(ROOTS_DASHBOARD, '/freeOrganization/list'),
    },
  },
  blog: {
  ...
  event: {
    ...
    all_events: {
      list: path(ROOTS_DASHBOARD, '/events/all-events'),
      preview: (slug: string) => path(ROOTS_DASHBOARD, `/events/all-events/${slug}`),
    },
    events: path(ROOTS_DASHBOARD, '/events'),
    event_tournaments: {
      new: (id: string) => path(ROOTS_DASHBOARD, `/events/${id}/tournaments/new`),
      tournament_dashboard: (id: string, tournamentSlug: string) =>
        path(ROOTS_DASHBOARD, `/events/${id}/tournaments/${tournamentSlug}`),
      list: (id: string) => path(ROOTS_DASHBOARD, `/events/${id}/tournaments`),
    },
  ...
  all_tournament: {
    list: path(ROOTS_DASHBOARD, '/tournaments/all-tournaments'),
    preview: (slug: string) => path(ROOTS_DASHBOARD, `/tournaments/all-tournaments/${slug}`),
  },
};
