...
import TournamentPublishNewEditForm from './TournamentPublishNewEditForm';

// ----------------------------------------------------------------------

export default function TournamentPublishPostPage() {
  const {
  ...
  return (
    <Container maxWidth={false}>
      ...
      <TournamentPublishNewEditForm isEdit currentTournament={tournament} />
    </Container>
  );
}
