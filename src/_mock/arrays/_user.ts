...
export const _applicationAbout = {
  id: _mock.id(1),
  cover: _mock.image.cover(1),
  name: _mock.name.fullName(1),
  course: _mock.course(1),
  see_gpa: _mock.see_gpa(1),
  eleven_gpa: _mock.eleven_gpa(1),
  twelve_gpa: _mock.twelve_gpa(1),
  english_score: _mock.english_score(1),
  english_test: _mock.english_test(1),
